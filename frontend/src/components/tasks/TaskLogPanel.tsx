    ...
    <div className="flex h-full flex-col gap-4">
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-hover)] px-4 py-3">
          ...
          <div className="mt-1 text-sm font-semibold text-[var(--text-primary)]">{lines.length} logs</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <div className="mt-1 text-sm font-medium text-[var(--text-primary)]">Real-time Execution Logs</div>
        </div>
        <button
          type="button"
          onClick={copyLogs}
