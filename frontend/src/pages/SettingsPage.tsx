...
function GeneralTab({
  ...
  return (
    <div className="space-y-8">
       <SettingGroup title="Appearance Theme" desc="Choose the appearance theme for the application, takes effect immediately.">
       ...
       <SettingGroup
         ...
         desc="The default behavior configured here will be directly reused by the account list and registration page."
       >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
           <SettingRow label="Default Registration Identity">
            <select
           ...
           <SettingRow label="Default Third-party Entry">
            <select
           ...
           <SettingRow label="Default Executor Type">
            <select
      ...
      <div className="border-t border-[var(--border)]" />
       ...
       <SettingGroup
         title="Browser Reuse"
         desc="When third-party accounts use background browser automation, usually need to reuse the browser already logged in on this machine."
       >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
...
function AboutTab() {
  ...
  return (
    <div className="space-y-8">
      <SettingGroup title="Version Info" desc="Current application version and update detection.">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          <div className="flex items-center justify-between px-4 py-4">
            <div>
              ...
              <div className="mt-0.5 text-xl font-bold tracking-tight text-[var(--text-primary)]">
                {info ? formatVersion(info.current) : checking ? 'Loading...' : '—'}
              </div>
            </div>
      ...
      <SettingGroup title="Project Info">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          <InfoRow label="Project Name" value="Any Auto Register" />
